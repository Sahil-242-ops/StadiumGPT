...
/**
 * Internal component to animate number transitions smoothly.
 *
 * @param props Contains target number value and styling suffix.
 * @returns Animated number display element.
 */
...
/**
 * Component displaying real-time sustainability and crowd statistics
 * dynamically refreshed from stadium backend endpoints.
 *
 * @returns The StatsBar JSX element.
 */
export default function StatsBar() {
  ...
  const items = [
    ...
    { icon: "🅿", label: "Parking", value: stats.parking_pct, suffix: "%" },
    {
      icon: "🌱",
      label: "Carbon Saved",
      value: stats.carbon_saved_tons,
      suffix: " T",
    },
    {
      icon: "💧",
      label: "Water Saved",
      value: stats.water_saved_litres,
      suffix: " L",
    },
  ];
