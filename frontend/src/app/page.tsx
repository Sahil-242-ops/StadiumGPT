  ...
  return (
    <div className={accessibilityMode ? 'accessibility-mode' : ''}>
        ...
        <div className="header__inner">
          <div className="header__brand">
            ...
            <div>
              ...
              <span className="header__subtitle">FIFA World Cup 2026 · AI Assistant</span>
            </div>
          </div>

          <nav className="header__controls" role="navigation" aria-label="Settings">
            <div className="lang-select" role="group" aria-label="Select language">
              {(['en', 'es', 'fr', 'hi'] as Language[]).map((lang) => (
                ...
                >
                  {lang === 'en' ? '🇺🇸 EN' : lang === 'es' ? '🇪🇸 ES' : lang === 'fr' ? '🇫🇷 FR' : '🇮🇳 HI'}
                </button>
              ))}
            </div>
            ...
            {user ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                {user.photoURL ? (
                  ...
                  <img
                    ...
                    style={{ width: '32px', height: '32px', borderRadius: '50%', border: '1px solid var(--accent-primary)' }}
                  />
                ) : (
                  <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'var(--accent-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>
              ...
              <button className="btn btn--primary btn--sm" onClick={() => setLoginOpen(true)} aria-label="Sign in">
                Sign In
              </button>
            )}
          </nav>
      ...
      <footer className="footer" role="contentinfo">
        <p>
          StadiumGPT &copy; 2026 &nbsp;&middot;&nbsp;
          Powered by <strong>Google Gemini</strong> &nbsp;&middot;&nbsp;
          <a href="/google-services" className="footer__link">Google Services</a> &nbsp;&middot;&nbsp;
          <a href="/admin" className="footer__link">Admin</a> &nbsp;&middot;&nbsp;
          <a href="/api/health" className="footer__link">Health</a>
        </p>
      </footer>
    </div>
  );
